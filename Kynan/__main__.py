...
def kynan_about_callback(update, context):
    ...
    if query.data == "kynan_":
        ...
        query.message.edit_text(
            ...
            "\n\n 🚀 𝙐𝙎𝙀𝙍𝘽𝙊𝙏 𝙂𝘾𝘼𝙎𝙏"
            "\n      ├ ʀᴘ. 15.000  [ ᴜsᴇʀʙᴏᴛ ʙɪᴀsᴀ ]"
            "\n      ├ ʀᴘ. 25.000  [ ᴜsᴇʀʙᴏᴛ ᴘʀᴇᴍɪᴜᴍ ]"
            "\n      └ sɪsᴛᴇᴍ ᴛᴇʀɪᴍᴀ ᴊᴀᴅɪ"
            "\n\n 🚀 𝘽𝙊𝙏 𝙈𝙐𝙎𝙄𝙆"
            ...
            "\n      └ sɪsᴛᴇᴍ ᴛᴇʀɪᴍᴀ ᴊᴀᴅɪ"
            "\n\n   ᴄᴀᴛᴀᴛᴀɴ:"
            "\n      1. sᴇᴍᴜᴀ ʙᴏᴛ ɪᴛᴜ ᴘᴇʀʙᴜʟᴀɴ ʙᴜᴋᴀɴ ᴘᴇʀᴛᴀʜᴜɴ / ᴘᴇʀᴍᴀɴᴇɴ
            "\n      2. ᴀᴘᴀʙɪʟᴀ ʙᴏᴛ ʏᴀɴɢ ᴀɴᴅᴀ ɪɴɢɪɴᴋᴀɴ ᴛɪᴅᴀᴋ ᴀᴅᴀ ᴅɪᴀᴛᴀs, sɪʟᴀᴋᴀɴ ᴘᴍ ꝛɪᴛσ"
            "\n      3. ᴄᴀᴛᴀᴛᴀɴ ʜᴇʀᴏᴋᴜ ʀᴀᴡᴀɴ sᴜsᴘᴇɴ ᴊᴀᴅɪ sᴀʏᴀ ᴅᴇᴘʟᴏʏ ᴅɪ ᴠᴘs."
            "\n      4. sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ ꝛɪᴛσ ᴜɴᴛᴜᴋ ᴍᴇʟɪʜᴀᴛ / ᴍᴇɴᴀɴʏᴀᴋᴀɴ ᴄᴏɴᴛᴏʜ ʙᴏᴛ."
            "\n\n   𝗦𝗘𝗞𝗜𝗔𝗡 𝗧𝗘𝗥𝗜𝗠𝗔 𝗞𝗔𝗦𝗜𝗛 🙏.",
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [
